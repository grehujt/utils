## make darknet.py take http image steam as input
- vi src/image.c
```c
...
- vi Makefile
```makefile
COMMON+= -I/usr/include/python3.5/ -I/usr/lib/python3.5/site-packages/numpy/core/include/numpy/
```
- vi darknet_cam.py
```python
from ctypes import *
...
lib = CDLL("/home/kris/darknet/libdarknet.so", RTLD_GLOBAL)
